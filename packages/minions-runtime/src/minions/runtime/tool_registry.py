...
def get_registered_tool_funcs() -> list[Callable[..., Any]]:
    """Return every tool function auto-collected by ``@tool_descriptor``."""
    return list(_REGISTERED_TOOL_FUNCS)
...
def tool_descriptor(
    ...
    **metadata: Any,
    ...
    Registered tools are discoverable via :func:`get_registered_tool_funcs`;
    higher layers decide which registered functions they own.
    """
