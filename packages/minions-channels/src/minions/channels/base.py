...
from .renderer import MessageRenderer, RenderStyle, strip_headline
from .schema import ChannelType
from ..security.access_control import get_access_control_store
...
class BaseChannel(ABC):
    ...
    def doctor_connectivity_notes(
        ...
        *,
        ...
        """Optional ``minions doctor --deep`` reachability checks.
    ...
    def build_agent_request_from_user_content(
        ...
        Uses :mod:`minions.schemas` Message / Content types directly — no
    ...
    async def send_approval_notification(
        ...
        *,
        ...
        back to plain text.
        """
        from minions.schemas import AgentRequest, Event
