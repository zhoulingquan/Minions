...
from ..runtime.prompt_manager import PromptManager, SyncPromptContributor
...
class MultimodalHintContributor(SyncPromptContributor):
    ...
    def contribute_sync(self, ctx: "HookContext") -> str | None:
        from .prompt import build_multimodal_hint
...
class ScrollContextContributor(SyncPromptContributor):
    ...
    def contribute_sync(self, ctx: "HookContext") -> str | None:
        ...
        if strategy != "scroll":
            return None
        from .context.scroll.prompt import build_scroll_system_prompt
