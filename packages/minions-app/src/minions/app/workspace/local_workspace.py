# -*- coding: utf-8 -*-
"""MinionsLocalWorkspace — routes tool management to ToolRegistry.

Subclasses AgentScope's :class:`LocalWorkspace` so that
:meth:`list_tools` returns Minions's own tools (managed by
...
class MinionsLocalWorkspace(AgentScopeLocalWorkspace):
    ...
    async def list_tools(  # type: ignore[override]
        ...
        *,
        ...
        """Return Minions tools, replacing AgentScope built-ins.
