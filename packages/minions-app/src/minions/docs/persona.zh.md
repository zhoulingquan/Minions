...
详细的操作规范和工作流程，包括业务经验使用原则、安全准则、工具使用说明等。这是智能体的"操作手册"，告诉它如何完成各种任务。
...
业务案例、证据、心得和操作方案由 SAGE 管理，不作为人设 Markdown 文件加载。SAGE 会在任务开始前按身份、作用域与当前目标准备相关 ActionPack，并在任务结束后记录结果、提炼候选经验。详细说明见 [SAGE 业务经验](./sage)。
