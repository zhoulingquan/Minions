...
class PluginLoader:
    ...
    async def unload_plugin(
        ...
        removes the plugin's tools through the configured typed host.
        ...
        # Remove tools that this plugin registered with the host.
    ...
    def _cleanup_plugin_tools(
        ...
        """Remove plugin tools through the configured typed host.
        ...
        require_plugin_host().unregister_tools(plugin_id, tool_names)
