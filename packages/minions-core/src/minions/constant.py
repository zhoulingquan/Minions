...
# Stable validation defaults. Asset discovery belongs to agents setup code;
# core constants must not inspect another distribution's package directory.
SUPPORTED_AGENT_LANGUAGES: frozenset[str] = frozenset(
    {"en", "id", "ru", "zh"},
)
