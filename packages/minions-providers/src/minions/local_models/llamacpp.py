...
class LlamaCppBackend:
    """
    Minions local model backend for managing llama.cpp server installation
    and setup.
    """
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"minions-llamacpp-download-{staging_dir.name}",
            command=["minions-llamacpp-download", download_url],
