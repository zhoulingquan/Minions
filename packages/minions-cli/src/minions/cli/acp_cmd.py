# -*- coding: utf-8 -*-
"""``minions acp`` — run Minions as an ACP agent over stdio."""
...
def acp_cmd(
    ...
    """Start Minions as an ACP agent (stdio)."""
    ...
    from ..agents.acp.server import run_minions_agent
    from ..app.acp_host import AppACPHostServices
