...
class InboxPage(BasePage):
    ...
    TAB_PUSH = (
        '.minions-tabs-tab:has-text("Push Messages"), '
        '.minions-tabs-tab:has-text("推送消息")'
    )
    TAB_APPROVALS = (
        '.minions-tabs-tab:has-text("Approvals"), '
        '.minions-tabs-tab:has-text("审批")'
    )
    ...
    # rendered as <sup class="minions-badge-dot"> inside the menu title.
    # data-menu-id is auto-generated by rc-menu (e.g. "rc-menu-uuid-N-inbox"),
    # so we anchor on the bilingual menu label instead.
    SIDEBAR_INBOX_BADGE = (
        'li.minions-menu-item:has(span.minions-menu-title-content:has-text("Inbox")) '
        '.minions-badge-dot, '
        'li.minions-menu-item:has(span.minions-menu-title-content:has-text("收件箱")) '
        '.minions-badge-dot'
    )

    # Detail modal
    DETAIL_MODAL = '.minions-modal'
    ...
    POPCONFIRM_OK = (
        ...
        '.minions-popover button.minions-btn-primary'
    )
