/**
 * plugins/types/minions.d.ts — stable public contract for plugin authors.
 *
 * Plugin TS projects (cloudpaw, minions-pet, …) should COPY this file into
 * their own `minions-host.d.ts` and uncomment the `declare global` block at
 ...
 *
 * Inside the host, the global `Window.Minions` is declared in
...
export interface MinionsChatNamespace {
  welcome: {
    set(
      pluginId: string,
      partial: Partial<{
...
export interface MinionsHostNamespace {
...
export interface MinionsWindowNamespace {
  host: MinionsHostNamespace;
...
// Plugin projects: uncomment this in your own minions-host.d.ts to type
// `window.Minions.*` accesses in plugin code.
//
// declare global {
//   interface Window {
//     Minions: MinionsWindowNamespace;
//   }
// }
