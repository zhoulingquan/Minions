...
LangString minionsCliPathPageTitle ${LANG_PORTUGUESEBR} "Command line"
LangString minionsCliPathPageSubtitle ${LANG_PORTUGUESEBR} "Choose whether minions is available in terminals."
LangString minionsCliPathPageDescription ${LANG_PORTUGUESEBR} "This adds the bundled minions command to your user PATH. You can change it later by reinstalling or uninstalling Minions Desktop."
LangString minionsCliPathCheckbox ${LANG_PORTUGUESEBR} "Add minions to PATH"
LangString minionsCliPathAdded ${LANG_PORTUGUESEBR} "Added minions to user PATH"
LangString minionsCliPathSkipped ${LANG_PORTUGUESEBR} "Skipped adding minions to user PATH"
LangString minionsCliPathMissing ${LANG_PORTUGUESEBR} "minions.exe was not found; skipped PATH update"
LangString minionsCliPathUpdateFailed ${LANG_PORTUGUESEBR} "Failed to update user PATH"
LangString minionsStopBackendPrompt ${LANG_PORTUGUESEBR} "O Minions ainda está em execução e está usando arquivos que o instalador precisa substituir.$\n$\nFeche o Minions (verifique a bandeja do sistema) e clique em Repetir para continuar. Clique em Cancelar para abortar a instalação."
