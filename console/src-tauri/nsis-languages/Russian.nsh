...
LangString minionsCliPathPageTitle ${LANG_RUSSIAN} "Command line"
LangString minionsCliPathPageSubtitle ${LANG_RUSSIAN} "Choose whether minions is available in terminals."
LangString minionsCliPathPageDescription ${LANG_RUSSIAN} "This adds the bundled minions command to your user PATH. You can change it later by reinstalling or uninstalling Minions Desktop."
LangString minionsCliPathCheckbox ${LANG_RUSSIAN} "Add minions to PATH"
LangString minionsCliPathAdded ${LANG_RUSSIAN} "Added minions to user PATH"
LangString minionsCliPathSkipped ${LANG_RUSSIAN} "Skipped adding minions to user PATH"
LangString minionsCliPathMissing ${LANG_RUSSIAN} "minions.exe was not found; skipped PATH update"
LangString minionsCliPathUpdateFailed ${LANG_RUSSIAN} "Failed to update user PATH"
LangString minionsStopBackendPrompt ${LANG_RUSSIAN} "Minions всё ещё запущен и использует файлы, которые установщику нужно заменить.$\n$\nЗакройте Minions (проверьте системный трей), затем нажмите «Повторить», чтобы продолжить. Нажмите «Отмена», чтобы прервать установку."
