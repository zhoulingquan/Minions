...
LangString minionsCliPathPageTitle ${LANG_ENGLISH} "Command line"
LangString minionsCliPathPageSubtitle ${LANG_ENGLISH} "Choose whether minions is available in terminals."
LangString minionsCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled minions command to your user PATH. You can change it later by reinstalling or uninstalling Minions Desktop."
LangString minionsCliPathCheckbox ${LANG_ENGLISH} "Add minions to PATH"
LangString minionsCliPathAdded ${LANG_ENGLISH} "Added minions to user PATH"
LangString minionsCliPathSkipped ${LANG_ENGLISH} "Skipped adding minions to user PATH"
LangString minionsCliPathMissing ${LANG_ENGLISH} "minions.exe was not found; skipped PATH update"
LangString minionsCliPathUpdateFailed ${LANG_ENGLISH} "Failed to update user PATH"
LangString minionsStopBackendPrompt ${LANG_ENGLISH} "Minions is still running and is using files the installer needs to replace.$\n$\nPlease quit Minions (check the system tray), then click Retry to continue. Click Cancel to abort the installation."
