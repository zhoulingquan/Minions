...
Example:
    >>> from minions.agents.model_factory import create_model_and_formatter
...
def _normalize_messages_for_formatter(
    ...
    if getattr(formatter_instance, "_minions_force_strip_media", False):
        ...
        if not global_model:
            raise ProviderError(
                message=(
                    ...
                    "Please configure a model using 'minions models config' "
...
def _create_formatter_instance(
    ...
    Returns:
        ...
        the model's native one, plus minions extensions for media
