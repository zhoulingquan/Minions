# -*- coding: utf-8 -*-
"""CLI command: run Minions app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run Minions app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing Minions app instance.
    """
    ...
    click.echo(f"Starting Minions app on {url} (port {port})")
