# -*- coding: utf-8 -*-
"""Minions streaming envelope schema.
...
minions's own envelope protocol — independent of agentscope's internal
event types.
"""
...
# ---------------------------------------------------------------------------
# Message envelope.
# minions's runner constructs an empty ``Message`` then calls
...
# These are constructed by minions rather than parsed from external input
