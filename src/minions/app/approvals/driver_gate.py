# -*- coding: utf-8 -*-
"""Minions application approval gate for Driver policy."""
...
class MinionsDriverApprovalGate:
    """Bridge Driver policy approval requests into Minions approval service."""

    async def request_approval(
        self,
        context: DriverInvocationContext,
    ) -> None:
        # Reuse Minions's approval Future flow: this coroutine pauses until
